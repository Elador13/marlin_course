...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <?php if (isset($_SESSION['_flash']['access_error'])): ?>
                <div class="alert alert-danger text-dark" role="alert">
                    <strong><?php display_flash_message('access_error'); ?></strong>
                </div>
            <?php endif ?>
            <?php if (isset($_SESSION['_flash']['edit_success'])): ?>
                <div class="alert alert-success">
                    <strong><?php display_flash_message('edit_success'); ?></strong>
                </div>
            <?php endif ?>
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="page_status.php?<?php echo 'id=' . $user['user_id']?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="page_avatar.php?<?php echo 'id=' . $user['user_id']?>">
